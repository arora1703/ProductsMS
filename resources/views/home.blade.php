    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>@if($products['status']==0){{ 'Active' }}@else{{ 'In-Active' }}@endif</td>
                <td style="text-align: center;">
                    <a class="btn btn-primary" href="{{ 'view/'.$products->id }}">View</a>
                    <a class="btn btn-warning" href="{{ 'edit/'.$products->id }}">Edit</a>
